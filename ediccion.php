...
<head>
    ...
    <title>MODIFICAR AUTOGESTIÓN</title>
</head>
<body>
    <div class="padre">
        <header class="header">
        ...
        <?php            
            require_once "php/modRegistro.php";
            error_reporting(E_ERROR | E_WARNING | E_PARSE | E_NOTICE );    
         ?> 

        <section class="section">
           <div class="titulo">
                    <h2>MODIFICAR AUTOGESTIÓN</h2>                 
                <div class="three-columns">                  
                    <div class="form-auto">                         
                        <form action="" class="form" id="miForm" method="POST">
                            ...
                            <input type="text" name="tiempoContacto" id="tiempoContacto" readonly value="<?php echo $tiempoContacto;; ?>"/>
                            <label for="">Tiempo Solucion</label>
                            <input type="text" name="tiempoSolucion" id="tiempoSolucion" readonly value="<?php echo $tiempoSolucion ; ?>">
                            <label for="">Tiempo Final</label>
                            <input type="text" name="tiempoFinal" id="tiempoFinal" readonly value="<?php echo $tiempoFinal; ?>"/>
                            <label for="">Estado Cable VGA</label>
                            <select name="estadoCableVga">
                                <option><?php echo $estadoCableVga; ?></option>
                                <option></option>
                                <option>BUENO</option>
                                <option>MALO</option>
                                <option>N/A</option>                               
                            ...
                            <select name="requiereCambioVga">
                                <option><?php echo $requiereCambioVga; ?></option>
                                <option></option>
                                <option>SI</option>
                                <option>NO</option>
                                <option>N/A</option>                               
                            ...
                            <select name="tipoCableVga" >
                                <option><?php echo $tipoCableVga; ?></option>
                                <option></option>
                                <option>V1.8A</option>
                                <option>V3.0</option>
                                <option>V4.5</option>
                            ...
                            <select name="estadoCableHdmi" >
                                <option><?php echo $estadoCableHdmi; ?></option>
                                <option></option>
                                <option>BUENO</option>
                                <option>MALO</option>
                                <option>N/A</option>                               
                            ...
                            <select name="requiereCambioHdmi">
                                <option><?php echo $requiereCambioHdmi; ?></option>
                                <option></option>
                                <option>SI</option>
                                <option>NO</option>
                                <option>N/A</option>                               
                            ...
                            <select name="tipoCableHdmi" >
                                <option><?php echo $tipoCableHdmi; ?></option>
                                <option></option>
                                <option>H1.8</option>
                                <option>H3.0</option>
                                <option>H4.5</option>
                            ...
                            <select name="estadoServicio">
                                <option><?php echo $estadoServicio; ?></option>
                                <option></option>
                            ...
                            <select name="soporteDatecsa" >
                                <option><?php echo $soporteDatecsa; ?></option>
                                <option></option>
                ...
                <div class="botones">                    
                    <button type="submit" name="guardar" id="guardar" class="guardar">Guardar</button>                   
                    <button type="button" class="registros" id="registros" onclick = "location='registros.php'" >Ver Registros</button>
